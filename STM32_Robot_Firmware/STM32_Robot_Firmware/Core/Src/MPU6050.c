...
void MPU6050_Initialization(void)
{
	...
	if(who_am_i == 0x68)
	{
		printf("MPU6050 who_am_i = 0x%02x...OK!", who_am_i);
	}
	else
	{
		printf("ERROR!!");
		printf("MPU6050 who_am_i : 0x%02x should be 0x68!", who_am_i);
		while(1)
		{
	...
	printf("LSB_Sensitivity_GYRO: %f, LSB_Sensitivity_ACC: %f!",LSB_Sensitivity_GYRO, LSB_Sensitivity_ACC);
